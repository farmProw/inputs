	...
	if (headerMenu) {
		headerMenu.querySelectorAll('.submenu--open').forEach(li => {
			li.addEventListener('click', function (e) {
				headerMenu.querySelectorAll('.submenu--open').forEach(li => {
					// li.querySelector('.header__submenu').classList.remove('active-submenu');
			...
			accordions.forEach(accordion => {
				...
				accordion.querySelectorAll("input[data-radio]").forEach(input => {
					...
					input.addEventListener('change', function (e) {
						...
						// check__price
						// let icon = this.closest('label').querySelector('.panel__icon');
						accordion.querySelectorAll("input[data-radio]").forEach(input => {

							// input.closest('label').classList.remove('panel__icon--checked')
...
// ddxc
	...
	// document.querySelector('.page').addEventListener('click', inputDateC)
